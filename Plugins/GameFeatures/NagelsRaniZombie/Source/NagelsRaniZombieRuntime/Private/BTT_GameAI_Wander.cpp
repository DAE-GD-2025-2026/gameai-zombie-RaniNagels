...
#include "BTT_GameAI_Wander.h"

#include "AIController.h"
#include "NavigationSystem.h"
#include "BehaviorTree/BlackboardComponent.h"

UBTT_GameAI_Wander::UBTT_GameAI_Wander()
{
	NodeName = TEXT("Find Wander Location");
}

EBTNodeResult::Type UBTT_GameAI_Wander::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
